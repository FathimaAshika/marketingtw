...
class StudentWeeklyReview extends Command {
    
    use PortalSummary;
    
    protected $signature = 'review:send_weekly';
    ...
    public function handle() {        
        ...
        $rstart_date = Carbon::now()->startOfWeek()->format('d/m/Y');
        $rend_date   = Carbon::now()->endOfWeek()->format('d/m/Y');
              ...
              if($stdentArr) {
                 foreach( $stdentArr as $stu_id => $stu_arr ) {                      
                     ...
                     if( $st_data ) {
                         ...
                         $emailData["portal_url"]        = $this->getPortalUrl()."review/weekly";
                         $view                           = "emails.review_weekly";
                        ...
                        //$emailData["email_to"]      = "lakshikasur@gmail.com";
                         ...
                         if($eml_succ) {
                               ...
                               $token_data["review_start_date"]= $stwk_dt;
                               $token_data["review_end_date"]  = $edwk_dt;
                               ...
                               $token_data["review_type"]      = "WEEKLY_REVIEW";
